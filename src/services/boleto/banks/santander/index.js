...
var formatters = require("../../helper/formatters");
var ediHelper = require("../../helper/edi-helper");
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      if (registro == "0") {
        ...
        if (segmento == "T") {
          ...
          parsedFile.boletos[currentNossoNumero]["valor_pago"] = formatters.removeTrailingZeros(
