...
const gerenteRegional = async ({ ref, agregador, politica }) => {
  return new Promise(async (resolve, reject) => {
    ...
    `,
      ...
      const [rowsRegras] = await db.execute(
        `SELECT * FROM comissao_politica_regras WHERE id_politica = '${politica.id}' AND cargo = 'gerente regional'`
      );
...
module.exports = gerenteRegional;
