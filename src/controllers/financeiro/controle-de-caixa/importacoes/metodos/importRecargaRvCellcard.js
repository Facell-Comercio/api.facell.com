    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            for (const row of rows) {
                ...
                const [rowFilial] = await conn.execute(`SELECT id FROM filiais WHERE cnpj = :cnpj `, { cnpj: cnpj })
            ...
            reject(error)
            logger.error({
                module: 'FINANCEIRO', origin: 'CONFERENCIA_DE_CAIXA', method: 'IMPORT_RECARGA_RVCELLCARD',
