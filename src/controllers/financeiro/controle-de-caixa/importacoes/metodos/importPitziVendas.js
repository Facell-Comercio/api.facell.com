...
module.exports = async (req) => {
    return new Promise(async (resolve, reject) => {
        ...
        try {
                ...
                .on("end", async () => {
                    ...
                    try {
                        ...
                        for (const row of rows) {
                            ...
                            const [rowFilial] = await conn.execute(`SELECT id FROM filiais WHERE nome_pitzi LIKE CONCAT('%', ? ,'%')`, [lojaPitzi])
                        ...
                        await conn.execute(`INSERT INTO logs_import_relatorio (id_user, relatorio, descricao ) VALUES (:id_user, :relatorio, :descricao)`,
                            {
                                id_user: req.user.id,
            ...
            logger.error({
                module: 'FINANCEIRO', origin: 'CONFERENCIA_DE_CAIXA', method: 'IMPORT_PITZI_VENDAS',
